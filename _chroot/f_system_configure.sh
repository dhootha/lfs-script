...
local LFS_FLAG='f_system-configure'
...
echo 'f_system-configure:' >> "${LFS_LOG}/system-configure.log"
echo '+++++++++++++++++++++++++++++++++++++++' >> "${LFS_LOG}/system-configure.log"
env >> "${LFS_LOG}/system-configure.log"
echo '+++++++++++++++++++++++++++++++++++++++' >> "${LFS_LOG}/system-configure.log"
...
echo ${ERR_FLAG} > "${LFS_LOG}/system-configure-flag"
